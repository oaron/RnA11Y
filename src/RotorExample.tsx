...
export default function RotorExample() {
  ...
  return (
    <AccessibilityCustomRotorsView style={styles.flex} rotors={[daysRotor, rainyRotor]}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {Platform.OS !== 'ios' && (
          <Text style={styles.note}>
            Custom rotors are iOS-only. On Android / Web this renders without rotor support.
          </Text>
        )}
        {forecast.map((f) => (
