...
// With VoiceOver normally you'd have to swipe through every line of every day
// to jump from "Monday" to "Friday". The custom rotor lets the user jump
// directly between day headings, and a second rotor lets them visit only the
// days where it's raining or storming.
//
// Try it: enable VoiceOver, focus inside the scroll view, rotate two fingers
// to open the rotor wheel, pick "Days" or "Rainy days", then swipe down/up.
